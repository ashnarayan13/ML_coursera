...
results = eye(64,3);
errorRow = 0;
%0:01; 0:03; 0:1; 0:3; 1; 3; 10; 30 test for these values of C and sigma
%gives total of 8*8 possibilities
...
%set C and sigma to the best values in terms of least errors
